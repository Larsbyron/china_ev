...
1. **Kostensenkung durch Partnerschaften**: Mit dem Partner-Hersteller gemeinsame Einkaufsvorteile nutzen.
2. **Kernkomponenten vor Ort**: In Märkte gehen, wo bereits ein Zulieferer wie CATL (宁德时代) eine Fabrik plant oder betreibt.
3. **Peripherie lokalisieren**: Kabelbäume, Glas, Reifen von lokalen Firmen beziehen – auch wenn es nicht günstiger ist, um die geforderten Lokalisierungsquoten zu erfüllen.
